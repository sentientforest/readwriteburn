<template>
  <div class="wallet-connect">
    <button v-if="!isConnected" class="button" @click="connectWallet">Connect Wallet</button>
    <div v-else>
      <p class="wallet-address">Connected: {{ truncatedAddress }}</p>
      <button v-if="!isRegistered" class="button" @click="registerUser">Register</button>
    </div>
  </div>
</template>
